...
class App extends Component {
  ...
  startTimer = () => {
    this.intervalId = setInterval(this.addTimer, 1000)
  }
  ...
  changeImage = () => {
    ...
    this.setState({imgId: imagesList[num].id, imgUrl: imagesList[num].imageUrl})
  }
  ...
  stopGame = () => {
    this.setState({gameOngoing: false})
    ...
    return (
      <>
        <div className="question-image-container">
          <img src={imgUrl} alt="match" className="image2" />
        </div>
        <ul className="thumbnails-selection-container">
      ...
      <div className="result-container">
        <div className="result">
          <img
            ...
            className="image3"
          />
          <p className="para1">YOUR SCORE</p>
          <p className="para1">{score}</p>
          <div className="reset-container">
            <button type="button" className="button3" onClick={this.resetGame}>
              <img
                src="https://assets.ccbp.in/frontend/react-js/match-game-play-again-img.png"
                alt="reset"
                className="image4"
              />
              <p className="para2">PLAY AGAIN</p>
            </button>
          </div>
        </div>
      </div>
  ...
  render() {
    const {score, timer, gameOngoing} = this.state
        ...
        <ul className="nav-bar">
          ...
          <li className="data-container">
            ...
            <img
              ...
              alt="timer"
            />
            <p className="span">{60 - timer} sec</p>
          </li>
        </ul>
        {gameOngoing ? this.returnBottom() : this.returnResult()}
      </div>
    )
  }
}
